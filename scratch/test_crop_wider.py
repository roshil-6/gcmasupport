...
with Image.open(latest_path) as img:
    ...
    vis_path = os.path.join(output_dir, "components_visualization_wider.png")
    vis_img.save(vis_path)
    print(f"Saved wider visualization to {vis_path}")
